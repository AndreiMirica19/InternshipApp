...
public class FirmAdapter extends ArrayAdapter<Candidate> {
    private Context context;
    int resource;
    public FirmAdapter(@NonNull Context context, int resource, @NonNull List<Candidate> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dbConnector.hire(getItem(position));
            }
        });
        companyText.setText("");
