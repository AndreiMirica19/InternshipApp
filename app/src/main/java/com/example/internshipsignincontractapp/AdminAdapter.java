...
public class AdminAdapter extends ArrayAdapter<Candidate> {
    private Context context;
    int resource;
    public AdminAdapter(@NonNull Context context, int resource, @NonNull List<Candidate> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dbConnector.sendConventionToFirm(getItem(position));
            }
        });
